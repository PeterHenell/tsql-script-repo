SET NOEXEC on
    ...
    --    METADATAFILE = N'C:\SQLskills\EE_WaitStats.xem')
     ...
     --   (SET slots = 32, filtering_event_name = 'sqlos.wait_info', source_type = 0, source = 'wait_type')
    ...
    ALTER EVENT SESSION MonitorWaits ON SERVER ADD EVENT sqlos.wait_info (WHERE sqlserver.session_id = 53)
