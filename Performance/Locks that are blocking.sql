...
WHERE
    ...
    --objectlock lockPartition=0 objid=325576198 subresource=FULL dbid=7 id=lock90da33880 mode=X associatedObjectId=325576198

--    SELECT DB_NAME(13)

USE DWH_0_Admin
SELECT * FROM sys.objects WHERE object_id = 325576198
